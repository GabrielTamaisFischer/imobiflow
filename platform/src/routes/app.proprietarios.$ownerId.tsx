...
function OwnerDashboardPage() {
  ...
  async function runQaHarness() {
    ...
    try {
      ...
      const response = await fetch("/api/internal/qa/fase-e-broker/final", { method: "POST", headers: { "Content-Type": "application/json", ...(token ? { Authorization: `Bearer ${token}` } : {}) }, body: "{}" });
