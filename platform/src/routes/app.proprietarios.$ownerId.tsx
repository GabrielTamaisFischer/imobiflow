...
function OwnerDashboardPage() {
  ...
  async function runFaseDBrokerProof() {
    ...
    if (!token) return;
    const foreignOwnerId = "9d28267a-7c99-4dbe-a052-152fa061fd5f";
    try {
