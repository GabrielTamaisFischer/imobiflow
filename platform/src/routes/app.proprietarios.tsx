...
import { OwnerDocumentsModal, readFileAsBase64 } from "@/components/real-estate/owner-documents-modal";
export { OwnerDocumentsModal, readFileAsBase64 };
...
// AJUSTE-FUNCIONAL-03 (2026-09-11): OwnerDocumentsModal e readFileAsBase64
// foram extraídos para um componente compartilhado (ver comentário lá) para
// que a Ficha do proprietário também possa reaproveitar o mesmo uploader.
