...
import { qaFaseFFinalRouter } from "./routes/qa-fase-f-final.js";
...
export function createApp() {
  ...
  // Temporary staging-only Fase F runtime verifier. Remove after one execution.
  app.use(qaFaseFFinalRouter);
