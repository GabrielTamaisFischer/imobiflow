...
import { qaFaseEBrokerRouter } from "./routes/qa-fase-e-broker.js";
...
export function createApp() {
  ...
  // Temporary staging-only Fase E Broker verification harness; remove after the gate.
  app.use("/internal/qa/fase-e-broker", qaFaseEBrokerRouter);
