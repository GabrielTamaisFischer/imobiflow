...
const plans = [
  ...
  { name: "Pro", price: "R$ 297", desc: "Para imobiliárias que querem escalar com automação.",
    ...
    cta: "Quero o Pro", highlight: true },
  { name: "Enterprise", price: "R$ 1.497", desc: "Para operações estruturadas e multi-filial.",
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {plans.map((p) => (
            ...
            >
              ...
              <button className={`mt-8 w-full rounded-full py-3 text-sm font-semibold transition ${
